...
# Используем временную папку на Railway
UPLOAD_FOLDER = "/tmp"
...
def chat_image():
    ...
    try:
        ...
        return jsonify({"response": "Изображение сохранено и обработано."})
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5000))  # Railway подставляет PORT
